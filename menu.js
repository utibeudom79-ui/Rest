...
const foods = [
  // RICE DISHES
  { id: 1, name: "Party Jollof Rice", price: 2500, category: "rice", desc: "Our signature smoky party jollof, slow-cooked over firewood with a rich tomato base, seasoned to perfection. The taste of every Nigerian celebration.", img: "https://images.unsplash.com/photo-1574484284002-952d92456975?w=600&q=80&fit=crop", protein: "Served with choice of protein", serves: "1 person", prep: "15 mins" },
  { id: 2, name: "Fried Rice", price: 2500, category: "rice", desc: "Light, flavourful fried rice tossed with mixed vegetables, liver, and seasoned chicken stock. A classic favourite.", img: "https://images.unsplash.com/photo-1512058564366-18510be2db19?w=600&q=80&fit=crop", protein: "With vegetables & liver", serves: "1 person", prep: "15 mins" },
  { id: 3, name: "White Rice & Stew", price: 3000, category: "rice", desc: "Perfectly cooked long-grain white rice paired with our house-made tomato and pepper stew, slow-simmered with assorted meat.", img: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600&q=80&fit=crop", protein: "With assorted meat stew", serves: "1 person", prep: "10 mins" },
  { id: 4, name: "Coconut Rice", price: 2800, category: "rice", desc: "Aromatic rice cooked in fresh coconut milk, subtly sweet and beautifully fragrant. A coastal delicacy.", img: "https://images.unsplash.com/photo-1634324092526-91f5e878b72f?w=600&q=80&fit=crop", protein: "Served with fried plantain", serves: "1 person", prep: "20 mins" },
  ...
  // SOUPS
  { id: 7, name: "Egusi Soup", price: 2500, category: "soups", desc: "Freshly ground melon seeds slow-cooked with palm oil, assorted meats, and a blend of native spices. Rich, hearty, and deeply satisfying.", img: "https://images.unsplash.com/photo-1547592180-85f173990554?w=600&q=80&fit=crop", protein: "With assorted meat & stockfish", serves: "1 person", prep: "20 mins" },
  { id: 8, name: "Ogbono Soup", price: 3500, category: "soups", desc: "Wild mango seed soup with a natural draw that coats every bite. Cooked with palm oil, peppers, and a generous helping of assorted meat.", img: "https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=600&q=80&fit=crop", protein: "With assorted meat & dry fish", serves: "1 person", prep: "20 mins" },
  { id: 9, name: "Afang Soup", price: 4000, category: "soups", desc: "A prized Akwa Ibom delicacy made with wild spinach (afang leaves) and waterleaf, rich with periwinkle, palm oil, and assorted proteins.", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80&fit=crop", protein: "With periwinkle & assorted meat", serves: "1 person", prep: "25 mins" },
  { id: 10, name: "Okra Soup", price: 4000, category: "soups", desc: "Fresh okra soup with a thick, satisfying draw. Packed with assorted meat, dry fish, and crayfish for an authentic taste.", img: "https://images.unsplash.com/photo-1548943487-a2e4e43b4853?w=600&q=80&fit=crop", protein: "With assorted meat & crayfish", serves: "1 person", prep: "20 mins" },
  { id: 11, name: "White Soup (Afia Efere)", price: 5000, category: "soups", desc: "The pride of Akwa Ibom cuisine. A delicate, pale soup made with fresh goat meat, periwinkle, and native spices. Elegant and unforgettable.", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?w=600&q=80&fit=crop", protein: "With fresh goat meat & periwinkle", serves: "1 person", prep: "30 mins" },
  { id: 12, name: "Edikan Ikong Soup", price: 4500, category: "soups", desc: "A nutritious, flavour-packed soup made with pumpkin leaves and waterleaf, loaded with assorted meats, seafood, and rich palm oil.", img: "https://images.unsplash.com/photo-1604329760661-e71dc83f8f26?w=600&q=80&fit=crop", protein: "With assorted seafood & meat", serves: "1 person", prep: "25 mins" },
  ...
  { id: 14, name: "Chicken Sauce", price: 2000, category: "proteins", desc: "Tender chicken pieces in a rich, spiced tomato and pepper sauce. Perfect as a side with any rice dish.", img: "https://images.unsplash.com/photo-1604908177453-7462950a6a3b?w=600&q=80&fit=crop", protein: "2-3 pieces per serving", serves: "1 person", prep: "15 mins" },
  { id: 15, name: "Fried Fish", price: 2500, category: "proteins", desc: "Freshly seasoned whole fish, deep-fried to a perfect golden crisp on the outside while staying moist and tender inside.", img: "https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80&fit=crop", protein: "One whole medium fish", serves: "1 person", prep: "15 mins" },
  ...
  { id: 23, name: "Strawberry Yoghurt", price: 600, category: "drinks", desc: "Creamy strawberry-flavoured yoghurt drink, smooth and naturally refreshing.", img: "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80&fit=crop", protein: "300ml bottle", serves: "1 person", prep: "Ready" },
  { id: 24, name: "Eva Water (50cl)", price: 200, category: "drinks", desc: "Pure, clean bottled water — the perfect accompaniment to any meal.", img: "https://images.unsplash.com/photo-1564419320461-6870880221ad?w=600&q=80&fit=crop", protein: "50cl bottle", serves: "1 person", prep: "Ready" },

  // COMBOS
  { id: 25, name: "Special Combo", price: 4500, category: "combos", desc: "Our best-value combo: Jollof Rice + Grilled Chicken + a soft drink of your choice. Everything you need in one satisfying order.", img: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=600&q=80&fit=crop", protein: "Rice + chicken + drink", serves: "1 person", prep: "20 mins" },
];
